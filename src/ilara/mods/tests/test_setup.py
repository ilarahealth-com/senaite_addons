...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("ilara.mods"))

    def test_browserlayer(self):
        """Test that IIlaraModsLayer is registered."""
        from ilara.mods.interfaces import IIlaraModsLayer
        from plone.browserlayer import utils

        self.assertIn(IIlaraModsLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("ilara.mods"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IIlaraModsLayer, utils.registered_layers())
